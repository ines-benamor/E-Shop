...
class UsersPasswordUpdate extends StatefulWidget {
  UsersPasswordUpdate({super.key});

  @override
  State<UsersPasswordUpdate> createState() => _UsersPasswordUpdateState();
}

class _UsersPasswordUpdateState extends State<UsersPasswordUpdate> {
        ...
        child: Column(
          children: [
            ...
            Card(
              ...
              child: ListTile(
                title: Text(
                    "Şifreniz en az 7 karakter ve en fazla 64 krakter olmalı, harf ve rakam içermelidir"),
              ),
            ),
            const SizedBox(
              height: 20,
            ...
            ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  bool passwordUpdateResult = await AuthService()
                  ...
                  if (passwordUpdateResult) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                            'Mevcut şifre doğru değil veya şifre güncelleme hatası'),
                        duration: Duration(seconds: 2),
                      ),
                    );
                  }
