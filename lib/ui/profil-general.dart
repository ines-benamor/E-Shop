...
class _ProfileGeneralState extends State<ProfileGeneral> {
  ...
  void initState() {
    super.initState();
    UsersProducts = firestoreService.getUserProducts();
  ...
  /*Future<void> fetchData() async {
    uid = await authService.getCurrentUsersId();
  }*/
                                    ...
                                    Container(
                                      ...
                                      child: CircleAvatar(
                                        backgroundImage: NetworkImage(
                                          UsersData["photoUrl"] ??
                                              "https://i.pinimg.com/736x/8b/25/91/8b259121597545e2739974384c18a8e6.jpg",
                                        ),
                                      ),
                                    ),
                                    Padding(
                            ...
                            Padding(
                              ...
                              child: Consumer<UserProvider>(
                                builder: (BuildContext context,
                                    UserProvider value, Widget? child) {
                                  return Text(
                                    UsersData["Usersname"] ?? "Kullanıcı",
                                    style: TextStyle(
